...
export declare class NoteAlgorithms {
    ...
    valueNoteNullifier(noteCommitment: Buffer, index: number, accountPrivateKey: Buffer, real?: boolean): Buffer;
    valueNoteNullifierBigInt(noteCommitment: Buffer, index: number, accountPrivateKey: Buffer, real?: boolean): bigint;
    ...
    claimNoteNullifier(noteCommitment: Buffer, index: number): Buffer;
